...
import {AuthenticatedEndgame, endgameCreateUser, endgameLogin, newEndgame} from "../app/endgame";
import {dialPeer} from "../p2p/networkClient";
import {floodRouter} from "../p2p/floodRouter";
import {Parcel} from '@parcel/core';
import {EndgameConfig} from "../app/endgameConfig";
import {handlers} from "../handlers/handlers";
import {createUserHandler} from "../handlers/auth-handlers/createUserHandler";
import {passwordAuthHandler} from "../handlers/auth-handlers/passwordAuthHandler";
import {
    memoryStoreGetHandler,
    memoryStoreGetMetaHandler,
    memoryStorePutHandler, memoryStoreRuleGetHandler, memoryStoreRulePutHandler
} from "../handlers/store-handlers/memoryStoreHandlers";
import {logoutHandler} from "../handlers/auth-handlers/logoutHandler";
