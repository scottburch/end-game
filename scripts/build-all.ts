...
const DIRS = ['local-state', 'rxjs-chain', 'utils', 'crypto', 'graph', 'loggers/console-logger', 'stores/level-store', 'auth/pwd-auth', 'p2p', 'test-utils', 'react-graph', 'dtg-scripts', 'cli', 'graph-explorer'];
